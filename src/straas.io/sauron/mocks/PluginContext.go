...
// This is an autogenerated mock type for the PluginContext type
...
func (_m *PluginContext) Errorf(_a0 string, _a1 ...interface{}) {
	_m.Called(_a0, _a1)
}

// Infof provides a mock function with given fields: _a0, _a1
func (_m *PluginContext) Infof(_a0 string, _a1 ...interface{}) {
	_m.Called(_a0, _a1)
}
